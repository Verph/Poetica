...
//Add Recipes
	...
	recipes.addShapeless(<betterwithmods:material:8> * 4, [<ore:leatherPineapple>, <ore:shears>.transformDamage(1)]);
...
//TFC Elementia:
	...
	//Metal Dusts
	mods.betterwithmods.Mill.addRecipe([<ore:ingotBismuth>], [<tfc:metal/dust/bismuth> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotBismuthBronze>], [<tfc:metal/dust/bismuth_bronze> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotBlackBronze>], [<tfc:metal/dust/black_bronze> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotBrass>], [<tfc:metal/dust/brass> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotBronze>], [<tfc:metal/dust/bronze> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotCopper>], [<tfc:metal/dust/copper> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotGold>], [<tfc:metal/dust/gold> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotLead>], [<tfc:metal/dust/lead> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotNickel>], [<tfc:metal/dust/nickel> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotRoseGold>], [<tfc:metal/dust/rose_gold> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotSilver>], [<tfc:metal/dust/silver> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotTin>], [<tfc:metal/dust/tin> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotZinc>], [<tfc:metal/dust/zinc> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotSterlingSilver>], [<tfc:metal/dust/sterling_silver> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotWroughtIron>], [<tfc:metal/dust/wrought_iron> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotPigIron>], [<tfc:metal/dust/pig_iron> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotSteel>], [<tfc:metal/dust/steel> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotPlatinum>], [<tfc:metal/dust/platinum> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotBlackSteel>], [<tfc:metal/dust/black_steel> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotBlueSteel>], [<tfc:metal/dust/blue_steel> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotRedSteel>], [<tfc:metal/dust/red_steel> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotAluminium>], [<tfc:metal/dust/aluminium> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotBoron>], [<tfc:metal/dust/boron> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotSilicium>], [<tfc:metal/dust/silicium> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotCadmium>], [<tfc:metal/dust/cadmium> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotCalcium>], [<tfc:metal/dust/calcium> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotCastIron>], [<tfc:metal/dust/cast_iron> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotCobalt>], [<tfc:metal/dust/cobalt> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotMagnesium>], [<tfc:metal/dust/magnesium> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotMercury>], [<tfc:metal/dust/mercury> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotStrontium>], [<tfc:metal/dust/strontium> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotTitanium>], [<tfc:metal/dust/titanium> * 8]);
	mods.betterwithmods.Mill.addRecipe([<ore:ingotZirconium>], [<tfc:metal/dust/zirconium> * 8]);
